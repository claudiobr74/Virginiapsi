...
export const documentBrandingRowSchema = z.object({
  ...
  show_address: z.boolean().optional().default(true),
  ...
  footer_clinic: z.boolean().optional().default(true),
  footer_professional: z.boolean().optional().default(true),
  footer_crp: z.boolean().optional().default(true),
  footer_phone: z.boolean().optional().default(false),
  footer_email: z.boolean().optional().default(false),
  footer_address: z.boolean().optional().default(false),
  footer_website: z.boolean().optional().default(false),
  footer_page_numbers: z.boolean().optional().default(true),
  footer_document_id: z.boolean().optional().default(true),
  footer_version: z.boolean().optional().default(true),
