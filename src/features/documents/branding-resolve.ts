...
export function defaultBranding(): DocumentBrandingRow {
  return documentBrandingFromPartial({});
}

function documentBrandingFromPartial(
  ...
  return {
    ...
    show_clinic_name: row.show_clinic_name ?? true,
    show_trade_name: row.show_trade_name ?? false,
    show_legal_name: row.show_legal_name ?? false,
    show_address: row.show_address ?? true,
    show_city: row.show_city ?? true,
    ...
    header_logo: row.header_logo ?? true,
    header_clinic: row.header_clinic ?? true,
    header_professional: row.header_professional ?? true,
    header_crp: row.header_crp ?? true,
    header_phone: row.header_phone ?? false,
    header_email: row.header_email ?? false,
    header_address: row.header_address ?? false,
    header_website: row.header_website ?? false,
    footer_clinic: row.footer_clinic ?? true,
    footer_professional: row.footer_professional ?? true,
    footer_crp: row.footer_crp ?? true,
    footer_phone: row.footer_phone ?? false,
    footer_email: row.footer_email ?? false,
    footer_address: row.footer_address ?? false,
    footer_website: row.footer_website ?? false,
    footer_page_numbers: row.footer_page_numbers ?? true,
    footer_document_id: row.footer_document_id ?? true,
    footer_version: row.footer_version ?? true,
    footer_hash: row.footer_hash ?? false,
...
export function resolveBranding(
  ...
  const branding = documentBrandingFromPartial(row ?? {});
  const clinic =
  ...
  return {
    ...
    phone: branding.show_phone ? branding.phone || branding.professional_phone || "" : "",
    email: branding.show_email ? branding.email || branding.professional_email || "" : "",
