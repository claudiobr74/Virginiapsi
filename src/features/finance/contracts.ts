...
export const chargeRowSchema = z.object({
  ...
  canceled_by: z.string().uuid().nullish(),
  cancel_reason: z.string().nullish(),
  nfse_requested_at: z.string().nullish(),
...
export const paymentRowSchema = z.object({
  ...
  registered_by: z.string().uuid().nullish(),
  idempotency_key: z.string().nullish(),
  created_at: z.string(),
  updated_at: z.string(),
});
...
export const expenseRowSchema = z.object({
  ...
  attachment_document_id: z.string().uuid().nullish(),
...
export const planRowSchema = z.object({
  ...
  total_sessions: z.coerce.number().int().nullish(),
  used_sessions: z.coerce.number().int(),
  price: moneyWire,
...
export const closingRowSchema = z.object({
  ...
  closed_by: z.string().uuid().nullish(),
  reopened_at: z.string().nullish(),
  reopened_by: z.string().uuid().nullish(),
  totals_snapshot: z.record(z.string(), z.unknown()).optional().default({}),
  created_at: z.string(),
  updated_at: z.string(),
});
