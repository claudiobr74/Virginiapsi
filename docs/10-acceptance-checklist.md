...
O estado honesto do release gate está em `docs/25-release-gate.md` (PASS / FAIL / EXTERNAL_BLOCKED). Não marcar Preview Vercel aqui enquanto o passo 10 do gate for EXTERNAL_BLOCKED.
