...
UI: lista com busca e filtros por situação, cadastro/edição em 4 seções (Identificação; Contato & Responsáveis; Atendimento & Situação; Financeiro & Termos — valor padrão + situação vigente dos termos/TCLE, com atalho para o prontuário). Patient Hub com "Dados do Paciente" e "Acompanhamento" (admin). Planos, pendências, extrato, documentos e TCLE ficam no hub.
